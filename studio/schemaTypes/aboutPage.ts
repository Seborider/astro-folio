    ...
    of: [
      defineArrayMember({
        ...
        fields: [
          ...
          defineField({ name: "detail", title: "Detail", type: "localeString", validation: (r) => r.required() }),
        ],
...
export default defineType({
  ...
  type: "document",
  fields: [
    defineField({ name: "metaTitle", title: "Meta title", type: "localeString", description: "Browser tab / SEO title." }),
    defineField({ name: "title", title: "Page title", type: "localeString", description: 'Hero heading, e.g. "Über".' }),
    defineField({ name: "lede", title: "Lede", type: "localeText" }),
    defineField({ name: "subMeta", title: "Hero meta", type: "localeString", description: 'e.g. "( Kopenhagen — seit 2014 )".' }),
    defineField({
      name: "introQuote",
    ...
    defineField({ name: "portraitCaption", title: "Portrait caption", type: "localeString", description: 'e.g. "Studio, Vesterbro". Also used as the image alt text.' }),
    defineField({ name: "portraitYear", title: "Portrait year", type: "string" }),
    defineField({ name: "capabilitiesHeading", title: "Capabilities heading", type: "localeString" }),
    row("capabilities", "Capabilities"),
    defineField({ name: "recognitionHeading", title: "Recognition heading", type: "localeString" }),
